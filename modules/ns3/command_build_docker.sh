...
# snap install docker
#
# After installing it, create new client and server containers.
# At the first terminal:
# docker run -it --privilleged --name client ubuntu bash
# At the second terminal:
# docker run -it --privilleged --name server ubuntu bash 
#
#
