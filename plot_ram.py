...
def plot_individual(n_users):
    ...
    plt.plot(time, yolo_ram, label="Comm. module", color=colors[3])
    plt.plot(time, airsim_ram, label="AI module", color=colors[1])
    plt.plot(time, unreal_ram, label="3D module", color=colors[0])
    plt.plot(time, ns3_ram, label="NATS", color=colors[2])
