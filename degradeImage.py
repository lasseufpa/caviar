...
dropped_package_indexes = rng.choice(total_number_of_packets, packets_to_drop, replace=False)
...
reconstructed_image_packets = bytes('', 'utf-8')
for packet in image_packets:
    reconstructed_image_packets = reconstructed_image_packets + packet.tobytes()


image_bytes_saveable = img.frombytes(mode="RGBA", size=image.size, data=reconstructed_image_packets, decoder_name='raw')
image_bytes_saveable.save("/home/joaoborges/codes/caviar/runs/detect/predict/fromBytes.png")